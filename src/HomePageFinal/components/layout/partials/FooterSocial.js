  ...
  return (
    ...
    >
      <ul className="list-reset">
        <li>
          <a href="https://www.facebook.com/SmartFinanceDEX/">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
        ...
        <li>
          <a href="https://twitter.com/smartfinancedex">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
        ...
        <li>
          <a href="https://discord.gg/smartfinance">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
