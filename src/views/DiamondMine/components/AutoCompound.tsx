    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledCardBody>
          ...
          <RowBlock>
            <Label size='18px'>{totalNodes} Diamonds</Label>            
          </RowBlock>
        </StyledCardBody>
        {/* <StyledCardBody> */}
        <StyledImg src='./images/diamondmine.png' alt='status_logo' />
        {/* </StyledCardBody> */}
        <Link to={{ pathname: "https://diamondmine.money/" }} target="_blank">
          <Label1 labelSize="8px"> Diamond Mine Dapp </Label1>
        </Link>
      </RowBlockBetween>
    </StyledCard>
  )
