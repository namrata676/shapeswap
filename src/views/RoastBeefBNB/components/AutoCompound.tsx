...
const TotalNodes = ({ title, val1, val2, img, account, refetch, farmersNodeContract }) => {
  ...
  return (
    <StyledCard>
      <RowBlockBetween>      
        <StyledImg src='./images/RoastBeefBNB.png' alt='status_logo' />
        <div className="d-flex justify-content-between">
          <Label labelSize='20px'>{totalNodes} Beef</Label>           
        </div>        
        <Link to={{ pathname: "https://roastedbeef.io/#/?ref=0x10bA6854F7C9A003c5898D5f8fafb2bBd3A8966C" }} target="_blank">
          <Label1 labelSize="8px"> RoastBeef BNB Dapp </Label1>
        </Link>
      </RowBlockBetween>
