...
const IncomeCard = ({ img, rewards, smnPrice, myNode, stormNodeContract, stormTokenContract, stormZv2Price }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/storm.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='14px'>
          $STORMZV2 Current Value
            </Label1>
          <Label labelSize='38px'> $ {(stormZv2Price*rewards).toFixed(4)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/storm.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            $STORMZV2 Current Value
            </Label1>
          <Labelm labelSize='22px'> $ {(stormZv2Price*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
