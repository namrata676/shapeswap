...
const IncomeCard = ({ img, rewards,  myNode, emeraldNodeContract, emeraldTokenContract, emPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/EmeraldN.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='18px'>
          $EM Current Rewards
            </Label1>
          <Label labelSize='38px'> $ {(emPrice*rewards).toFixed(4)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/EmeraldN.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            $EM Current Rewards Value
            </Label1>
          <Labelm labelSize='22px'> $ {(emPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
