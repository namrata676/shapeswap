...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setEmPrice }) => {

        
  const TOKEN = '0x97E7044ab98B7891546485f5f66EDcc2F58be106'
  ...
  useEffect(() => {
    fetch(API)
        ...
        setEmPrice(data.pairs[0]?.priceUsd)}
         )
