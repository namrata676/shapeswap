...
const TotalNodes = ({ title, val1, val2, img, account, refetch, emeraldTokenContract, emeraldNodeContract,token }) => {
  ...
  const getTotalNodes = () => {
    ...
    if (ethereum) {
        ...
        emeraldNodeContract.methods.RegularNodeCounter().call().then( function( info ) {
             setTotalNodes(info)
           })
         } 
