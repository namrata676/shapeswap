...
const IncomeCard = ({ img, rewards, smnPrice, myNode, starNodeContract, starTokenContract, strzPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/strz.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='14px'>
          $STRZ Current Rewards Value
            </Label1>
          <Label labelSize='38px'> $ {(strzPrice*rewards).toFixed(4)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/strz.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            $STRZ Current Rewards Value
            </Label1>
          <Labelm labelSize='22px'> $ {(strzPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
