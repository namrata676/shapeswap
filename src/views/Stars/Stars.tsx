...
const starnodeNodeHandler = "0x232C43377fb629302A9CB1546b1A473b74F69527"
  ...
  const [token, setToken] = useState('star_nodes')
  const [strzPrice, setStrzPrice] = useState(0)
    ...
    <BrowserView>
      <Page>
        <Cards>
          ...
          <Info starNodeContract={starNodeContract} title="Info" val1="6500" val2={-5} account={account}  refetch={refetch} img='images/status2.jpg' />
          <SMNprice  title="$SMRT" val1="$0" val2={0} account={account} setStrzPrice={setStrzPrice} img='images/status1.jpg' setSmnPrice={setSmnPrice} refetchLocation={refetchLocation} />
          <TotalNodes title="Total Nodes" val1="6500" val2={-5} account={account}  refetch={refetch} token={token} img='images/status2.jpg' starTokenContract={starTokenContract} starNodeContract={starNodeContract}/>          
        </Cards>
        <BigCards>
          <IncomeCard img='images/earn.gif' rewards={rewards}  smnPrice={smnPrice} myNode={myNode} starTokenContract={starTokenContract} starNodeContract={starNodeContract} strzPrice={strzPrice}/>
            <CustomCards>
              <AvailReward account={account}  setRewards={setRewards} token={token} starTokenContract={starTokenContract} starNodeContract={starNodeContract}/>          
              <CreateNewNode account={account} setRefetch={setRefetch}  refetch={refetch}  starTokenContract={starTokenContract} starNodeContract={starNodeContract} token={token}/>
            </CustomCards>
        </BigCards>        
      </Page>
      </BrowserView>
      ...
      <Page>
        <Cards>
        <AutoCompound title="Auto Compound" status={false} img1='images/status4.jpg' img2='images/status42.jpg' setToken={setToken}/>
          <Info title="Info" val1="6500" val2={-5} account={account} starNodeContract={starNodeContract} refetch={refetch} img='images/status2.jpg' />
          <SMNprice  title="$SMRT" setStrzPrice={setStrzPrice} val1="$0" val2={0} account={account} img='images/status1.jpg' setSmnPrice={setSmnPrice} refetchLocation={refetchLocation} />
          <TotalNodes title="Total Nodes" val1="6500" val2={-5} account={account} token={token}starTokenContract={starTokenContract} starNodeContract={starNodeContract} refetch={refetch} img='images/status2.jpg' />          
        </Cards>
        <BigCards>
          <IncomeCard img='images/earn.gif' rewards={rewards}  smnPrice={smnPrice} myNode={myNode} starTokenContract={starTokenContract} starNodeContract={starNodeContract} strzPrice={strzPrice} />
            <CustomCards>
              <AvailReward account={account} starTokenContract={starTokenContract} starNodeContract={starNodeContract} setRewards={setRewards} token={token} />          
              <CreateNewNode account={account} setRefetch={setRefetch} starTokenContract={starTokenContract} starNodeContract={starNodeContract} token={token} refetch={refetch}/>
            </CustomCards>
        </BigCards>       
      </Page>
      </MobileView>
