...
const TotalNodes = ({ title, val1, val2, img, account, refetch, projectxNodeContract }) => {
  ...
  useEffect(() => {
    ...
    if(account !== undefined){
      ...
      projectxNodeContract.methods._getNodeNumberOf(account).call().then( function( info ) {
          setTotalNodes(info)
         })
       } 
