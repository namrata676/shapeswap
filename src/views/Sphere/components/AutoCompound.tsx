...
const TotalNodes = ({ title, val1, val2, img, account, refetch, farmersNodeContract }) => {
  ...
  return (
    <StyledCard>
      <RowBlockBetween>            
        <StyledImg src='./images/sphere-t.png' alt='status_logo' />
        <div className="d-flex justify-content-between">
        <Heading scale="sm" mb="10px">
            my balance 
          </Heading>
          <Label labelSize='20px'>{totalNodes} sphere</Label>           
        </div>        
        <Link to={{ pathname: "https://app.sphere.finance/dashboard" }} target="_blank">
          <Label1 labelSize="8px"> sphere dapp </Label1>
        </Link>
      </RowBlockBetween>
