...
const IncomeCard = ({ img, rewards, smnPrice, myNode, polarNodeContract, polarTokenContract, polarPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/polarupdate.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='18px'>
          Current $POLAR Value
            </Label1>
          <Label labelSize='38px'> $ {(polarPrice*rewards).toFixed(4)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/polarnupdate.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
          Current $POLAR Value
            </Label1>
          <Labelm labelSize='22px'> $ {(polarPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
