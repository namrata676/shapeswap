...
const TotalNodes = ({ title, val1, val2, img, account, refetch, farmersNodeContract }) => {
  ...
  return (
    <StyledCard>
      <RowBlockBetween>      
        <StyledImg src='./images/safuu-t.png' alt='status_logo' />
        <div className="d-flex justify-content-between">
          <Label labelSize='20px'>{totalNodes} safuu</Label>           
        </div>        
        <Link to={{ pathname: "https://app.safuu.com/#/dashboard/" }} target="_blank">
          <Label1 labelSize="8px"> safuu dapp </Label1>
        </Link>
      </RowBlockBetween>
