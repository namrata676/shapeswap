...
import TotalNodes from 'views/DiamondMine/components/AutoCompound';
...
const IncomeCard = ({ img, rewards, smnPrice, myNode, nebulaNodeContract, nebulaTokenContract, nebuPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/nebula.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='18px'>
          $NEBU Current Rewards
            </Label1>
          <Label labelSize='38px'> $ {(nebuPrice*rewards).toFixed(4)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/nebula.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            $NEBU Current Rewards Value
            </Label1>
          <Labelm labelSize='22px'> $ {(nebuPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
