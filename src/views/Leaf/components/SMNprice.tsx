...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setLeafPrice, farmersNodeContract }) => {

        
  const TOKEN = '0xa787A4ABB13F56F6A6dB7E9E55DCE748Ef3a36bB'
  ...
  useEffect(() => {
    fetch(API)
        ...
        setLeafPrice(data.pairs[0]?.priceUsd)}
         )
