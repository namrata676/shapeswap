...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setNebuPrice }) => {

        
  const TOKEN = '0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79'
  ...
  useEffect(() => {
    fetch(API)
        ...
        setNebuPrice(data.pairs[0]?.priceUsd)}
         )
