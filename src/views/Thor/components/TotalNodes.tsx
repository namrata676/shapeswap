...
const TotalNodes = ({ title, val1, val2, img, account, refetch, thorTokenContract, thorNodeContract,token }) => {
  ...
  const getTotalNodes = () => {
    ...
    if (ethereum) {
        ...
        thorTokenContract.methods.getTotalCreatedNodes().call().then( function( info ) {
             setTotalNodes(info)
             console.log("infototal",info)
           })
         } 
