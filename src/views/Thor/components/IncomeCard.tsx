...
const IncomeCard = ({ img, rewards, smnPrice, myNode, thorNodeContract, thorTokenContract, nebuPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/thornodesnew.png' alt='status_logo' />
        <StyledCardBody>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/thornodes.png' alt='status_logo' />
        <StyledCardBody>
