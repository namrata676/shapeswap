...
const TotalNodes = ({ title, val1, val2, img, account, refetch, farmersNodeContract }) => {
  ...
  return (
    <StyledCard>
      <RowBlockBetween>      
        <StyledImg src='./images/leviathan-t.png' alt='status_logo' />
        <div className="d-flex justify-content-between">
          <Label labelSize='20px'>{totalNodes} levia</Label>           
        </div>        
        <Link to={{ pathname: "https://www.leviathan-dapp.com/" }} target="_blank">
          <Label1 labelSize="8px"> leviathan dapp </Label1>
        </Link>
      </RowBlockBetween>
