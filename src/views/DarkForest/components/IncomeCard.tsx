...
const IncomeCard = ({ img, rewards,  myNode, DarkForestNodeContract, DarkForestTokenContract, NartPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/DarkForestN.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='18px'>
          $Dark Forest Current Rewards Value
            </Label1>
          <Label labelSize='38px'> $ {(NartPrice*rewards).toFixed(2)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/DarkForestN.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            $Dark Forest Current Rewards Value
            </Label1>
          <Labelm labelSize='22px'> $ {(NartPrice*rewards).toFixed(2)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
