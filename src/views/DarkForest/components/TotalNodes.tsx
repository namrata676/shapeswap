...
const TotalNodes = ({ title, val1, val2, img, account, refetch, DarkForestTokenContract, DarkForestNodeContract,token }) => {
  ...
  const getTotalNodes = () => {
    ...
    if (ethereum) {
        ...
        DarkForestNodeContract.methods.totalSupply().call().then( function( info ) {
             setTotalNodes(info)
           })
         } 
