...
const TotalNodes = ({ title, val1, val2, img, account, refetch, gorillaTokenContract, gorillaNodeContract,token }) => {
  ...
  const getTotalNodes = () => {
    ...
    if (ethereum) {
        ...
        gorillaNodeContract.methods.totalNodesCreated().call().then( function( info ) {
             setTotalNodes(info)
           })
         } 
