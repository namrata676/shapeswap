...
const IncomeCard = ({ img, rewards, smnPrice, myNode,  gorillaPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImg src='./images/gorillalogo.png'  />
        <StyledCardBody>
          <Label1 labelSize='18px'>
            Current $BANANA Value 
            </Label1>
          <Label labelSize='38px'> $ {(gorillaPrice*rewards).toFixed(4)}</Label>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/gorillalogo.png'  />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            Current $BANANA Value
            </Label1>
          <Labelm labelSize='22px'> $ {(gorillaPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
