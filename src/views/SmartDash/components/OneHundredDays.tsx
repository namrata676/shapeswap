...
const OneHundredDays = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setReactPrice, farmersNodeContract }) => {

  const TOKEN = '0x6d2f5dBf3a7396FCe32CfE406Aef7a8AFF812Fbb'
  ...
  return (
    <StyledCard>
      <RowBlockBetween>
        ...
        {/* <StyledCardBody> */}
        <StyledImg src='./images/100days-t.png' alt='status_logo' />
        {/* </StyledCardBody> */}
      </RowBlockBetween>
    </StyledCard>
  )
