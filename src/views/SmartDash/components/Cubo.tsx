...
const Storm = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setReactPrice, farmersNodeContract }) => {

  const TOKEN = '0xF1fC473eBCE089F572540DacCAA20785Cf8d00B5'
  ...
  return (
    <StyledCard>
      <RowBlockBetween>
        ...
        {/* <StyledCardBody> */}
        <StyledImg src='./images/cubo-t.png' alt='status_logo' />
        {/* </StyledCardBody> */}
      </RowBlockBetween>
    </StyledCard>
  )
