...
const Star = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setReactPrice, farmersNodeContract }) => {

        
  const TOKEN = '0x1D67454f6b393542290a7bBEeA32c66148909b34'
