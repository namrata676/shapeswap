...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setReactPrice, farmersNodeContract }) => {

        
  const TOKEN = '0xd33df97747dD6bEcAD26B2e61F818c94B7588E69'
  ...
  return (
    <StyledCard>
      <RowBlockBetween>
        ...
        {/* <StyledCardBody> */}
        <StyledImg src='./images/react1.png' alt='status_logo' />
        {/* </StyledCardBody> */}
      </RowBlockBetween>
    </StyledCard>
  )
