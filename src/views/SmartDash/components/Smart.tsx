...
const Smart = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setReactPrice, farmersNodeContract }) => {

        
  const TOKEN = '0x712b05710bcFe9C9B1DF08D0f846f42c3D457F3E'
  ...
  return (
    <StyledCard>
      <RowBlockBetween>
        ...
        {/* <StyledCardBody> */}
        <StyledImg src='./images/home/Logo-02.png' alt='status_logo' /> 
        {/* </StyledCardBody> */}
      </RowBlockBetween>
    </StyledCard>
  )
