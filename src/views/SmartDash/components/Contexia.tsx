...
const Contexia = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setReactPrice, farmersNodeContract }) => {

        
  const TOKEN = '0x9ADCbba4b79eE5285E891512b44706F41F14CAFd'
  ...
  return (
    <StyledCard>
      <RowBlockBetween>
        ...
        {/* <StyledCardBody> */}
        <StyledImg src='./images/contexiafin.png' alt='status_logo' />
        {/* </StyledCardBody> */}
      </RowBlockBetween>
    </StyledCard>
  )
