...
const Lava = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setReactPrice, farmersNodeContract }) => {

  const TOKEN = '0x0adD05dC5eF7c622CeD36aF14cDF1ca360AEae86'
