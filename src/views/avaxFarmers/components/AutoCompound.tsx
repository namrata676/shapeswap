...
const TotalNodes = ({ title, val1, val2, img, account, refetch, farmersNodeContract }) => {
  ...
  return (
    <StyledCard>
      <RowBlockBetween>      
        <StyledImg src='./images/avaxfarmermain.png' alt='status_logo' />
        <div className="d-flex justify-content-between">
          <Label labelSize='20px'>{totalNodes} Farmers</Label>           
        </div>        
        <Link to={{ pathname: "https://avaxfarmer.io/" }} target="_blank">
          <Label1 labelSize="8px"> AvaxFarmer Dapp </Label1>
        </Link>
      </RowBlockBetween>
