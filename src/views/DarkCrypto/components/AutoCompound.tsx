...
const TotalNodes = ({ title, val1, val2, img, account, refetch, farmersNodeContract }) => {
  ...
  return (
    <StyledCard>
      <RowBlockBetween>      
        <StyledImg src='./images/darkcrypto-t.png' alt='status_logo' />
        <div className="d-flex justify-content-between">
          <Label labelSize='20px'>{totalNodes} Dark</Label>           
        </div>        
        <Link to={{ pathname: "https://www.darkcrypto.finance/" }} target="_blank">
          <Label1 labelSize="8px"> DarkCrypto Dapp </Label1>
        </Link>
      </RowBlockBetween>
