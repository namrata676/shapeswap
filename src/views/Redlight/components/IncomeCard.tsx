...
const IncomeCard = ({ img, rewards, smnPrice, myNode, redlightNodeContract, redlightTokenContract, playmatesPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/redlightlogo.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='18px'>
          Current $PLAYMATES Value
            </Label1>
          <Label labelSize='38px'> $ {(playmatesPrice*rewards).toFixed(4)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/redlightlogo.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            Current $PLAYMATES Value
            </Label1>
          <Labelm labelSize='22px'> $ {(playmatesPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
