...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setplaymatesPrice }) => {

        
  const TOKEN = '0x490bf3ABcAb1fB5c88533d850F2a8d6D38298465'
  ...
  useEffect(() => {
    fetch(API)
        ...
        setplaymatesPrice(data.pairs[0]?.priceUsd)}
         )
