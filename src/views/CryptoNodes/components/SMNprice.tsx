...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setCRNDPrice }) => {

        
  const TOKEN = '0x2EfB4FEc95DeAAb8c199CA5089E0cFD52373f92D'
  ...
  useEffect(() => {
    fetch(API)
        ...
        setCRNDPrice(data.pairs[0]?.priceUsd)}
         )
