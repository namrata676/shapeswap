...
const IncomeCard = ({ img, rewards, smnPrice, myNode, cryptoNodeContract, cryptoTokenContract, CRNDPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/cryptonodes.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='14px'>
          $CRND Current Value
            </Label1>
          <Label labelSize='38px'> $ {(CRNDPrice*rewards).toFixed(4)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/cryptonodes.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            $CRND Current Value
            </Label1>
          <Labelm labelSize='22px'> $ {(CRNDPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
