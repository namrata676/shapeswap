...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setMnodePrice }) => {

        
  const TOKEN = '0xc468f872961200ecaB30Cff4E618e7dEA8aeDD4D'
  ...
  useEffect(() => {
    fetch(API)
        ...
        setMnodePrice(data.pairs[0]?.priceUsd)}
         )
