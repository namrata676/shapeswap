...
const IncomeCard = ({ img, rewards, smnPrice, myNode, MnodeNodeContract, MnodeTokenContract, MnodePrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledImg src='./images/multinode.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='18px'>
          Current Mnode Value
            </Label1>
          <Label labelSize='38px'> $ {(MnodePrice*rewards).toFixed(2)}</Label>         
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/multinode.png' alt='status_logo' />
        <StyledCardBody>
          <Label1 labelSize='12px'>
          Current Mnode Value
            </Label1>
          <Labelm labelSize='22px'> $ {(MnodePrice*rewards).toFixed(2)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
