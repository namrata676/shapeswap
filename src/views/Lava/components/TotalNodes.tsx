...
const TotalNodes = ({ title, val1, val2, img, account, refetch, lavaTokenContract, lavaNodeContract,token }) => {
  ...
  const getTotalNodes = () => {
    ...
    if (ethereum) {
        ...
        lavaNodeContract.methods.totalNodesCreated().call().then( function( info ) {
             setTotalNodes(info)
           })
         } 
