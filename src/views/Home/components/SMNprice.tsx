  ...
  const getReserve = async () =>{
    ...
    if (ethereum) {
        ...
        smnContract.methods.joePair().call().then( function( info ) {
          ...
          const joeContract = new web3.eth.Contract(joePairAbi as any, info)

          joeContract.methods.getReserves().call().then( function( info1 ) {
            // console.log(info1[1]/info1[0])
            setReserveValue(info1[1]/info1[0]) 

            setSmnPrice((info1[1]/info1[0])*usdtPrice)
    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledCardBody>
          ...
          <RowBlock>
            <Label size='15px'>${(reserveValue*usdtPrice).toFixed(4)}</Label>
