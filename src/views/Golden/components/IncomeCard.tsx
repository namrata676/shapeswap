...
const IncomeCard = ({ img, rewards, smnPrice, myNode,  goldenPrice }) => {
  ...
  return (
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImg src='./images/goldensociety.png'  />
        <StyledCardBody>
          <Label1 labelSize='18px'>
            Current $GDSY Rewards 
            </Label1>
          <Label labelSize='38px'> $ {(goldenPrice*rewards).toFixed(4)}</Label>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </BrowserView>
    ...
    <StyledCard>
      <RowBlockBetween>
      <StyledImgm src='./images/goldensociety.png'  />
        <StyledCardBody>
          <Label1 labelSize='12px'>
            Current $GDSY Rewards
            </Label1>
          <Labelm labelSize='22px'> $ {(goldenPrice*rewards).toFixed(4)}</Labelm>          
        </StyledCardBody>
      </RowBlockBetween>
    </StyledCard>
    </MobileView>
