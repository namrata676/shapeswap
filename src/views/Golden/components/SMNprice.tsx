...
const SMNprice = ({ title, val1, val2, img, account, setSmnPrice, refetchLocation, setGoldenPrice }) => {

        
  const TOKEN = '0xfc4a2a15d6574f0b5d5b723cd4dea750a5612bf3'
  ...
  useEffect(() => {
    fetch(API)
        ...
        setGoldenPrice(data.pairs[0]?.priceUsd)}
         )
