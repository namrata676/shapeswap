    ...
    <StyledCard>
      <RowBlockBetween>
        <StyledCardBody>
          ...
          <RowBlock>
            <Label size='18px'>{totalNodes} React</Label>            
          </RowBlock>
        </StyledCardBody>
        {/* <StyledCardBody> */}
        <StyledImg src='./images/react.png' alt='status_logo' />
        {/* </StyledCardBody> */}        
        <Link to={{ pathname: "https://app.react.ac/account" }} target="_blank">
          <Label1 labelSize="8px"> React Dapp</Label1>
        </Link>
      </RowBlockBetween>      
    </StyledCard>
  )
